...
public class OrderSQL {
	...
	public final static String ORDER_SELECT_BY_USERID = "select * from orders where user_id=?";
	public final static String ORDER_SELECT_WITH_PRODUCT_BY_USERID ="select * from orders o join order_item oi on o.order_no=oi.order_no"
			+ " join product p on oi.product_no=p.product_no where o.user_id=? and o.order_no = ?";

...
insert into order_item(oi_no,oi_qty,product_no,order_no) values(order_item_oi_no_SEQ.nextval,1,orders_o_no_SEQ.currval,1);
insert into order_item(oi_no,oi_qty,product_no,order_no) values(order_item_oi_no_SEQ.nextval,1,orders_o_no_SEQ.currval,2);

insert into product(product_no, product_category, product_name, product_image, product_read_count)
			values(product_no_SEQ.nextval, '수공예', '[수원] 나만의 뿌리는 향수 만들기 원데이클래스', 'images/nothing.jpg', 0);
insert into product(product_no, product_category, product_name, product_image, product_read_count)
			values(product_no_SEQ.nextval, '수공예', '[원데이/성수] 색의 매력에 빠져드는 마블 물레 도자기 원데이클래스', 'images/nothing.jpg', 0);			
insert into product(product_no, product_category, product_name, product_image, product_read_count)
			values(product_no_SEQ.nextval, '수공예', '[송파구/잠실] 자연을 담은 5925 실버반지/ 주얼리만들기', 'images/nothing.jpg', 0);			
